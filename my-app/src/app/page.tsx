            ...
            {predictionResults ? (
              <div className={styles.resultsContainer}>
                ...
                <p className={styles.resultItem}>
                  <strong>Estimado para el mes actual:</strong> {predictionResults.currentMonth.toFixed(2)} kg
                </p>
                <p className={styles.resultItem}>
                  <strong>Predicción para el próximo mes:</strong> {predictionResults.nextMonth.toFixed(2)} kg
                </p>
                <p className={styles.resultItem}>
                  <strong>Predicción para los próximos dos meses:</strong> {predictionResults.twoMonths.toFixed(2)} kg
                </p>
